 ...
 */
public class ReviewAction implements TaskDiffAction {
    ...
    public IStatus execute(IProgressMonitor monitor) {
        ...
        ReviewDialog dialog = new ReviewDialog(null, client,_reviewRequestId, _diffMapper.getNumberOfDraftComments(_diffRevisionId));
        dialog.open();
